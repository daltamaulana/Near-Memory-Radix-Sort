...
module axi_data_mover_v1_0 
	...
	//   			AXI Master Unit                //
	//---------------------------------------------//
	bram_dram_mover_v1_0_M00_AXI_TO_DMA #(
	...
	) bram_dram_mover_v1_0_M00_AXI_TO_DMA_unit (
		// User defined ports
	...
	//   			 AXIS Slave Unit                //
	//----------------------------------------------//
	bram_dram_mover_v1_0_S00_AXIS #(
		.C_S_AXIS_TDATA_WIDTH(C_S00_AXIS_TDATA_WIDTH)
	) bram_dram_mover_v1_0_S00_AXIS_unit (
		// Control signal
	...
	//   			AXIS Master Unit                //
	//----------------------------------------------//
	bram_dram_mover_v1_0_M00_AXIS #(
		.C_M_AXIS_TDATA_WIDTH(C_M00_AXIS_TDATA_WIDTH)
	) bram_dram_mover_v1_0_M00_AXIS_unit (
		// User ports
	...
	//-------------------------------------------------------//
	bram_dram_mover_main_unit bram_dram_mover_main_unit
	(
		// Clock and Reset

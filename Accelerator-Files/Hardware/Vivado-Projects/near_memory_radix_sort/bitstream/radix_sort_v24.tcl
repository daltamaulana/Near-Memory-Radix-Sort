...
xilinx.com:user:radix_sort_accelerator:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: radix_sort_accelerat_0, and set properties
  set radix_sort_accelerat_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:radix_sort_accelerator:1.0 radix_sort_accelerat_0 ]
  set_property -dict [ list \
 ...
 ] $radix_sort_accelerat_0

  # Create instance: radix_sort_accelerat_0_axi_periph, and set properties
  set radix_sort_accelerat_0_axi_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 radix_sort_accelerat_0_axi_periph ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
   CONFIG.NUM_SI {2} \
 ] $radix_sort_accelerat_0_axi_periph
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins radix_sort_accelerat_0/S00_AXIS]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins radix_sort_accelerat_0/s00_axi_from_ps]
  connect_bd_intf_net -intf_net radix_sort_accelerat_0_M00_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins radix_sort_accelerat_0/M00_AXIS]
  connect_bd_intf_net -intf_net radix_sort_accelerat_0_axi_periph_M00_AXI [get_bd_intf_pins axi_dma_0/S_AXI_LITE] [get_bd_intf_pins radix_sort_accelerat_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net radix_sort_accelerat_0_m00_axi_to_dma [get_bd_intf_pins radix_sort_accelerat_0/m00_axi_to_dma] [get_bd_intf_pins radix_sort_accelerat_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins ps8_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM1_FPD [get_bd_intf_pins radix_sort_accelerat_0_axi_periph/S01_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]

  # Create port connections
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins radix_sort_accelerat_0/m00_axi_to_dma_aresetn] [get_bd_pins radix_sort_accelerat_0/m00_axis_aresetn] [get_bd_pins radix_sort_accelerat_0/s00_axi_from_ps_aresetn] [get_bd_pins radix_sort_accelerat_0/s00_axis_aresetn] [get_bd_pins radix_sort_accelerat_0_axi_periph/ARESETN] [get_bd_pins radix_sort_accelerat_0_axi_periph/M00_ARESETN] [get_bd_pins radix_sort_accelerat_0_axi_periph/S00_ARESETN] [get_bd_pins radix_sort_accelerat_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins radix_sort_accelerat_0/m00_axi_to_dma_aclk] [get_bd_pins radix_sort_accelerat_0/m00_axis_aclk] [get_bd_pins radix_sort_accelerat_0/s00_axi_from_ps_aclk] [get_bd_pins radix_sort_accelerat_0/s00_axis_aclk] [get_bd_pins radix_sort_accelerat_0_axi_periph/ACLK] [get_bd_pins radix_sort_accelerat_0_axi_periph/M00_ACLK] [get_bd_pins radix_sort_accelerat_0_axi_periph/S00_ACLK] [get_bd_pins radix_sort_accelerat_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0xB0008000 -range 0x00008000 -target_address_space [get_bd_addr_spaces radix_sort_accelerat_0/m00_axi_to_dma] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0xA4000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radix_sort_accelerat_0/s00_axi_from_ps/reg0] -force

...
module radix_sort_accelerator_main_unit
	...
	(
		...
		output wire [DATAADDRWIDTH-1:0] O_POINTER0, 
        output wire [DATAADDRWIDTH-1:0] O_POINTER1,
		output wire [DATAADDRWIDTH-1:0] O_ADDR1,
		output wire [DATAADDRWIDTH-1:0] O_ADDR2,
		output wire O_SORT_START,
		output wire O_SORT_START_DELAY
	);
	...
	(
		...
		//        Debug Signal        //
		////////////////////////////////
		.O_LI_COUNT(O_LI_COUNT),
		.O_RS_COUNT(O_RS_COUNT),
		.O_SO_COUNT(O_SO_COUNT),
		.O_ALL_COUNT(O_ALL_COUNT),
	...
	//NOTE: Debug purpose
	assign O_SORT_START = w_scu_sorting_start;
	...
	(
        ...
        // Debug signal
        .D_SORT_STATE(O_SORT_STATE),
        .D_FIRST_STATE(O_FIRST_STATE),
        .D_EVEN_STATE(O_EVEN_STATE),
        .D_ODD_STATE(O_ODD_STATE),
        .D_DATA_STATE(O_DATA_STATE),
        .D_SORT_START_DELAY(O_SORT_START_DELAY),
        .D_POINTER_0(O_POINTER0), 
        .D_POINTER_1(O_POINTER1)
	);

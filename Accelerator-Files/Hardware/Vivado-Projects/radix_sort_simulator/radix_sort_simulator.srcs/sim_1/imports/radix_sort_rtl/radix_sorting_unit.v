...
module radix_sorting_unit
    ...
    reg [DATAADDRWIDTH-1:0] r_mixed_pointer;
    ...
    assign w_count_0 = r_mixed_pointer;
    assign w_count_1 = DATABRAMDEPTH - r_mixed_pointer - 1;
    ...
    assign w_sorter_mixed_flag = ((r_sort_state == EVEN_DIGIT) && (r_sort_state == FIRST_DIGIT)) ? r_first_mixed_flag :
                                 ((r_sort_state == EVEN_DIGIT) && (r_sort_state == ODD_DIGIT)) ? r_odd_mixed_flag :
                                 (r_sort_state == ODD_DIGIT) ? r_even_mixed_flag :
                                 (r_sort_state == DATA_REARRANGE) ? r_even_mixed_flag : 1'b0;

    assign w_sorter_data_pattern = ((r_sort_state == EVEN_DIGIT) && (r_sort_state == FIRST_DIGIT)) ? r_first_data_pattern :
                                 ((r_sort_state == EVEN_DIGIT) && (r_sort_state == ODD_DIGIT)) ? r_odd_data_pattern :
    ...
    begin
        ...
        begin
            r_sort_state_prev <= r_sort_state;
        end   
    end
    ...
    begin
        ...
        begin
            if (r_first_state == FIRST_LAST_WRITE)
            begin
        ...
        begin
            case (r_first_state)
                ...
                begin
                    ...
                    r_mixed_pointer <= r_mixed_pointer;
                ...
                begin
                    ...
                    r_first_pointer_0 <= 0;
                    r_first_pointer_1 <= DATABRAMDEPTH - 1;
                    r_mixed_pointer <= r_first_pointer_0;
                    // Set read and write pointer
                    r_first_addr_even <= 0; 
                    r_first_addr_odd <= 0;
                    // Set write enable signal
    ...
    begin
        ...
        begin
            case (r_even_state)
                ...
                EVEN_ZERO_MIDDLE_RW:
                begin
                    if (r_even_addr_odd == (r_mixed_pointer - 1))
                    begin
    ...
    begin
        ...
        begin
            if (r_even_state == EVEN_LAST_WRITE)
            begin
        ...
        begin
            case (r_even_state)
                ...
                begin
                    ...
                    r_even_pointer_0 <= 0;
                    r_even_pointer_1 <= DATABRAMDEPTH - 1;
                    r_mixed_pointer <= r_even_pointer_0;
                    // Set read and write pointer
                    r_even_addr_even <= 0; 
                    r_even_addr_odd <= 0;
                    // Set write enable signal
    ...
    begin
        ...
        begin
            case (r_odd_state)
                ...
                ODD_ZERO_MIDDLE_RW:
                begin
                    if (r_odd_addr_even == (r_mixed_pointer - 1))
                    begin
        ...
        begin
            case (r_odd_state)
                ...
                begin
                    ...
                    r_odd_pointer_0 <= 0;
                    r_odd_pointer_1 <= DATABRAMDEPTH - 1;
                    r_mixed_pointer <= r_odd_pointer_0;
                    // Set read and write pointer
                    r_odd_addr_odd <= 0; 
                    r_odd_addr_even <= 0;
                    // Set write enable signal
    ...
    begin
        ...
        begin
            case (r_data_state)
                ...
                begin
                    if (r_data_addr_even == r_mixed_pointer)
                    begin
        ...
        begin
            case (r_data_state)
                ...
                begin
                    ...
                    r_data_shifter_start <= 0;
                    // Set read pointer signal
                    if (r_data_addr_even == (r_mixed_pointer + 1))
                    begin
                        r_data_addr_even <= r_data_addr_even;
                    end
                    else
                ...
                begin
                    ...
                    r_data_pointer_0 <= 0;
                    r_data_pointer_1 <= DATABRAMDEPTH - 1;
                    r_mixed_pointer <= r_data_pointer_0;
                    // Set read and write pointer
                    r_data_addr_odd <= 0;
                    r_data_addr_even <= 0;
                    // Set write enable signal

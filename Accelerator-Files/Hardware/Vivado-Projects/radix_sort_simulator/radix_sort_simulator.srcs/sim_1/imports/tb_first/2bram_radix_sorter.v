...
module two_bram_radix_sorter
    ...
    assign data_out = (state == DATA_REARRANGE) ? w_shifter_cache_data :
                      (first_state == FIRST_DONE || even_state == EVEN_DONE || odd_state == ODD_DONE )? sorted_cache[1] : sorted_cache[0];     

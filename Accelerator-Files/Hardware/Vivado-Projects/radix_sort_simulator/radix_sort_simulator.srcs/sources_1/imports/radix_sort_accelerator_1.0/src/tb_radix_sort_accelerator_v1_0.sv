...
module tb_radix_sort_accelerator_v1_0 ();
    ...
    **********************************************************/
    ...
    localparam DATA_SIZE = 4096;
    reg [31:0] Data_RAM[0:DATA_SIZE-1];
    initial
    begin
        $readmemh("C:/Projects/Accelerator/near-memory-radix-sort/Hardware/radix_sort_simulator/radix_sort_simulator.srcs/sources_1/imports/radix_sort/descend_unsorted_32.mem", Data_RAM);
    end

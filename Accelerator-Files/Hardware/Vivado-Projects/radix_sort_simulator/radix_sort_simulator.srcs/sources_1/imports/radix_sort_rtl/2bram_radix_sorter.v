...
module two_bram_radix_sorter
    ...
    ///////////////////////////////////////
    assign addr1 = (state == FIRST_DIGIT) ? r_first_addr1 : (state == EVEN_DIGIT) ? r_even_addr1 : (state == ODD_DIGIT) ? r_odd_addr1 : (state == DATA_REARRANGE) ? r_data_addr1 : 10'd0;
    assign addr2 = (state == FIRST_DIGIT) ? r_first_addr2 : (state == EVEN_DIGIT) ? r_even_addr2 : (state == ODD_DIGIT) ? r_odd_addr2 : (state == DATA_REARRANGE) ? r_data_addr2 : 10'd0;   
